    ...
    <>
      ...
      <Card
        sx={{
          ...
          borderRadius: "7px",
          mb: "25px",
          padding: { xs: "18px", sm: "20px", lg: "15px 25px" },
        }}
        className="rmui-card"
      >
        <code
        ...
        >
          &lt;<span style={{ color: "#905" }}>i</span>{" "}
          <span style={{ color: "#690" }}>class</span>=
          <span style={{ color: "#07a" }}>&quot;ri-home-7-line&quot;</span>
          &gt;&lt;/<span style={{ color: "#905" }}>i</span>&gt;
        </code>
      </Card>
      ...
      <Grid container columnSpacing={{ xs: 1, sm: 2, md: 2, lg: 3 }}>
        ...
        <Grid size={{ xs: 12, sm: 4, md: 3, lg: 3, xl: 2 }}>
          ...
          >
            <i
              className="ri-emoji-sticker-line"
              style={{ fontSize: "25px" }}
            ></i>
